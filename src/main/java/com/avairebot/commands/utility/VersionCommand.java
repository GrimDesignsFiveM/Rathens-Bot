...
public class VersionCommand extends Command {
    ...
    public String getDescription() {
        return "Displays the current version of Rathens Bot that is running. If the version is outdated the new version will be shown as well as what type of changes have been made.";
    }
    ...
    public boolean onCommand(CommandMessage context, String[] args) {
        ...
        if (latestVersion == null) {
            return sendErrorMessage(context, "Failed to fetch the latest version of Rathens Bot, try again later.");
        }
    ...
    private SemanticVersion getLatestVersion() {
        Object version = avaire.getCache().getAdapter(CacheType.FILE).remember("github.version", 1800, () -> {
            try {
                return Jsoup.connect("https://github.com/GrimDesignsFiveM/Rathens-Bot/blob/master/build.gradle")
